          ...
          >
            ...
            <label htmlFor="email" className="flex flex-col">
              ...
              <input
                ...
                value={form.email}
                onChange={handleChange}
                placeholder="imvkohli@email.com"
            ...
            <button
              ...
              className="bg-tertiary py-3 px-8 outline-none w-fit text-white hover:bg-white hover:text-tertiary font-bold shadow-md shadow-primary hover:shadow-[0px_0px_8px_2px_rgba(255,255,255,0.8)] rounded-xl disabled:bg-tertiary/20 disabled:text-white/60"
              disabled={loading}
              aria-disabled={loading}
            >
              {/* check loader state */}
